...
import "./Styles.css";
function ConcreteRepair({ formData, notify, setModalOpen, newService, setNewService, AddService, handleClickOpen, chemicalDropDown }) {
  ...
  const types = chemicalDropDown?.concrete_repair_types;
  const brands = chemicalDropDown?.concrete_repair_brands;
  ...
  useEffect(() => {
    ...
    setNewService({ ...newService, info: final_arr, type: "Concrete Repair" })
