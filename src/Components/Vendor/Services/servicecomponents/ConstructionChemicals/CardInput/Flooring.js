...
function Flooring({ formData, notify, setModalOpen, newService, setNewService, AddService, handleClickOpen, chemicalDropDown }) {
  ...
  useEffect(() => {
    ...
    setNewService({ ...newService, info: final_arr, type: "Flooring" })
