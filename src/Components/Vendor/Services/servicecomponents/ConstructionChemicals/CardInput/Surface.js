...
function Surface({ formData, notify, setModalOpen, newService, setNewService, AddService, handleClickOpen, chemicalDropDown }) {
  ...
  const types = chemicalDropDown?.surface_treatments_types;
  const brands = chemicalDropDown?.surface_treatments_brands;
  ...
  useEffect(() => {
    ...
    setNewService({ ...newService, info: final_arr, type: "Surface treatments" })
