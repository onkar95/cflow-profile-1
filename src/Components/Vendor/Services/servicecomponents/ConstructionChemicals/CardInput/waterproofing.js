...
function Waterproofing({ formData, notify, setModalOpen, newService, setNewService, AddService, handleClickOpen, chemicalDropDown }) {
  ...
  const types = chemicalDropDown?.waterproofing_types;
  const brands = chemicalDropDown?.waterproofing_brandss;
  ...
  useEffect(() => {
    setTypeCheck({ ...typecheck, 0: selectAll, 1: selectAll, 2: selectAll, 3: selectAll, 4: selectAll, 5: selectAll, 6: selectAll, 7: selectAll, 8: selectAll, 9: selectAll })
  }, [selectAll])

  useEffect(() => {
    setBrandCheck({ ...brandcheck, 0: selectAll0, 1: selectAll0, 2: selectAll0, 3: selectAll0, 4: selectAll0, 5: selectAll0, 6: selectAll0, 7: selectAll0, 8: selectAll0 })
  }, [selectAll0])
  useEffect(() => {
    let brandtemp = []
    let typetemp = []
    ...
    let info_arr = { brand: brandtemp, type: typetemp }
    setNewService({ ...newService, info: final_arr, type: "Waterproofing" })
