...
function Sealant({ formData, notify, setModalOpen, newService, setNewService, AddService, handleClickOpen, chemicalDropDown }) {
  ...
  const types = chemicalDropDown?.sealant_types;
  const brands = chemicalDropDown?.sealant_brands;
  ...
  useEffect(() => {
    ...
    setNewService({ ...newService, info: final_arr, type: "Sealant" })
