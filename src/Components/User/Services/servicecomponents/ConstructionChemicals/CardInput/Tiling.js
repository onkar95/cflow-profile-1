...
function Tiling({ formData, setNewRequest, setOpenSaved, quantity, setQuantity, newRequest, setModalOpen, setData, chemicalDropDown }) {
    ...
    const types = chemicalDropDown?.Tiling_types;
    const brands = chemicalDropDown?.Tiling_brands;
